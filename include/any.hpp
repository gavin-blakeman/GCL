...
//                      more details.
//
//                      You should have received a copy of the GNU General Public License along with GCL.  If not, see
...
namespace GCL
{
  ...
  ///
  /// @note 1.  The GCL::any class is necessary for GCL::sqlWriter functionality.
